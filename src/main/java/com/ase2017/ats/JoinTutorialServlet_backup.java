...
public class JoinTutorialServlet_backup extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if (student == null && joinTutorial) { // Student not in objectify
			...
			//Attandance.createAttandance(tutorial_id, user.getUser, null, null);
			...
			student = new Student(user.getUserId(), user.getNickname(), user.getEmail(), tutorial_id);
			ObjectifyService.ofy().save().entity(student).now();
			//Attandance.createAttandance(tutorial_id, tutorial_id, null, null);
			...
			ObjectifyService.ofy().save().entity(student).now();
			//Attandance.deleteAttandance(tutorial_id, tutorial_id);
		}
